...
\begin{enumerate}
    ...
    \item A partir del siguiente diagrama de transiciones (siguiente autómata no determinista):
      \begin{figure}[h]
        \centering
        \includegraphics[width = 1\textwidth]{ejercicio8}
      \end {figure}
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width = 1\textwidth]{ejercicio10}
    \end {figure}   
    ...
    \item Reduce los siguientes autómatas finitos deterministas a su forma mínima:
      ...
      \item
        \begin{figure}[ht]                                                     
        \includegraphics[width = 0.5\textwidth]{ejercicio11a}
        \end {figure}
      \item
        \begin{figure}[ht]
            \includegraphics[width = 0.5\textwidth]{ejercicio11b}
        \end {figure}   
